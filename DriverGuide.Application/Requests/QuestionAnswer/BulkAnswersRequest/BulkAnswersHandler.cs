...
public class BulkAnswersHandler(IQuestionAnswerRepository questionAnswerRepository) : IRequestHandler<BulkAnswersRequest, Unit>
{
    public async Task<Unit> Handle(BulkAnswersRequest request, CancellationToken cancellationToken)
    {
