...
namespace DriverGuide.Infrastructure.Migrations
{
    ...
    [Migration("20260104164245_AddForeignKeysWithoutNavigationProperties")]
    partial class AddForeignKeysWithoutNavigationProperties
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DriverGuide.Domain.Models.Question", b =>
                {
                    ...
                    b.Property<int>("TimeToAnswerSeconds")
                        ...
                        .HasColumnType("int")
                        .HasDefaultValue(30)
                        .HasColumnName("TimeToAnswerSeconds");
